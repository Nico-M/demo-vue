<template>
  <div class="screen-one text-white">
      ...
      <div class="screen-content">
        <el-row>
          ...
          <el-col :span="14">
            ...
            <china-map-remote class="mt-16" />
          </el-col>
          <el-col :span="5">
            <ranking-list class="mt-20" />
            <workload-list class="mt-24" :workList="workList" />
...
import ChinaMapRemote from "./components/ChinaMapRemote.vue";
  ...
  data() {
    return {
      ...
      workList: [
        ...
        { id: "09", type: "季度财务报表户数每户份数", count: 323 },
        { id: "10", type: "月度财务报表户数每户份数", count: 334 },
        { id: "11", type: "月度财务报表户数每户份数", count: 235 },
        { id: "12", type: "月度财务报表户数每户份数", count: 145 },
      ],
    };
  },
  mounted() {
